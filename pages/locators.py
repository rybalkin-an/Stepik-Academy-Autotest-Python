...
class MainPageLocators():
    ...
    RU_CATALOG_MENU_ALL_ITEMS = (By.XPATH, "//ul[@id='browse']//a[@href='/ru/catalogue/']")
    RU_CATALOG_MENU_CLOTHING = (By.XPATH, "//ul[@id='browse']//a[@href='/ru/catalogue/category/clothing_1/']")
    RU_CATALOG_MENU_BOOKS = (By.XPATH, "//ul[@id='browse']//a[@href='/ru/catalogue/category/books_2/']")
    RU_CATALOG_MENU_OFFERS = (By.XPATH, "//ul[@id='browse']//a[@href='/ru/offers/']")
    BOOK_ITEM_IN_CATALOG = (By.LINK_TEXT, "The shellcoder's handbook")
    BOOK_ITEM_IN_CATALOG_ADD_BASKET_BUTTON = (By.XPATH, "//form[contains(@action,'/basket/add/209/')]//button\
    [contains(@type,'submit')]")
    BUY_BOOK_ITEM_FROM_CATALOG_CONFIRM_MSG = (By.XPATH, "//div[contains(@class,'alertinner')]//strong[contains\
    (text(),'The shellcoder')]")
